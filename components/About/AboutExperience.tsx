...
import aboutStyles from "@styles/about/aboutExperience.module.scss";

export const AboutExperience = () => {
  return (
    <>
      <div className={aboutStyles[`history`]}>
        <div className={aboutStyles[`history__title`]}>
          <Title level="h3">History</Title>
        </div>
        <p className={aboutStyles[`history__year--student`]}>
          <time dateTime="2007-04-01">2007年</time> -{" "}
          <time dateTime="2011-03-31">2011年</time>
        </p>
        <div className={aboutStyles[`history--student`]}>
          <p className={aboutStyles.history__titleText}>
            HAL大阪専門学校 WEB開発学科
          </p>
          <p className={aboutStyles.history__text}>
            基本情報技術者試験の資格取得やPHP、JavaScriptなどを使用しプログラミングの基礎などを学習しました。
          </p>
        </div>
        <p className={aboutStyles[`history__year--newGraduate`]}>
          <time dateTime="2011-04-01">2011年</time> -{" "}
          <time dateTime="2017-04-30">2017年</time>
        </p>
        <div className={aboutStyles[`history--newGraduate`]}>
          <p>株式会社ドアズ</p>
          <p>
        ...
        <p className={aboutStyles[`history__year--currentJob`]}>
          <time dateTime="2017-05-01">2017年</time> -
        </p>
        <div className={aboutStyles[`history--currentJob`]}>
